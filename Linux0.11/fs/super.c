...
mount_root
  ?排蘨 ?诘憬峁贡匦胧?2 ?纸诙晕募?4 ?  罱谐跏蓟绻募低呈侨砼痰幕埃吞崾静迦敫蹋椿爻导跏蓟犊槭椋ü?
  ?睿┒寥「璞干系某犊楹透鵬 ?诘憬峁剐畔⑸柚酶鵬 ?诘阋么问? ?  ⒆魑? ?牡鼻肮ぷ髂柯己透柯嫉膇 ?  诘恪８萋呒槲煌纪臣瓶障信炭槭⑾允靖輎 ?诘阄煌纪臣瓶障衖 ?  诘闶⑾允痉祷?// 嵌入式汇编宏。参数bitnr 是比特位偏移值，addr 是测试比特位操作的起始地址。
